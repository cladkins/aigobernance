...
window.SURVEY_DATA={
  "questions": [
    ...
    },
    {
      ...
      "consultantNote": "BlueVoyant's take: the CLI version is safer than a blanket desktop handoff only if you keep it project-scoped and permission-scoped. It still crosses a serious boundary: a terminal AI session can ask for GUI control, clipboard access, and app approvals. Allow it for simulator testing and GUI-only QA on managed Macs, not as a default developer capability.",
      "id": "ctrl_10",
      "vendor": "Anthropic"
    },
    {
